...
describe("guardrail-fuzzer-pack-client", () => {
  ...
  it("saves corpus, runs deterministic fuzz reports, and plans CI gates with method-aware payloads", async () => {
    const spy = vi
      .spyOn(globalThis, "fetch")
