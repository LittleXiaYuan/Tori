...
export interface WASMPluginRemoteInstallSignatureVerificationWritebackInput {
  request_id?: string;
  request_key?: string;
  slug?: string;
  approved: boolean;
...
export interface WASMPluginRemoteInstallInstallerRegistrationPlanInput {
  request_id?: string;
  request_key?: string;
  slug?: string;
  approved?: boolean;
...
export interface WASMPluginSignatureVerificationRecord {
  pack_id: string;
  generated_at: string;
  status: string;
  signature_verification_writeback_ready: boolean;
...
export interface WASMPluginSignatureVerificationStoreSummary {
  pack_id: string;
  store: string;
  store_ready: boolean;
  record_count: number;
...
export interface WASMPluginInstallerRegistrationPlan {
  pack_id: string;
  generated_at: string;
  installer_registration_plan_ready: boolean;
...
export interface WASMPluginRemoteInstallInstallerRegistrationPlan {
  pack_id: string;
  generated_at: string;
  status: string;
  installer_registration_plan_ready: boolean;
...
export interface WASMPluginPackClient {
  ...
  remoteInstallSignatureVerificationWriteback(
    input: WASMPluginRemoteInstallSignatureVerificationWritebackInput,
  ): Promise<{
  ...
  remoteInstallInstallerRegistrationPlan(
    input: WASMPluginRemoteInstallInstallerRegistrationPlanInput,
  ): Promise<{
...
export function createWASMPluginPackClient(): WASMPluginPackClient {
  return {
    ...
    remoteInstallSignatureVerificationWriteback: (input) =>
      fetcher<{
        writeback: WASMPluginRemoteInstallSignatureVerificationWriteback;
    ...
    remoteInstallInstallerRegistrationPlan: (input) =>
      fetcher<{ plan: WASMPluginRemoteInstallInstallerRegistrationPlan }>(
