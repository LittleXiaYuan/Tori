...
for (const token of ["createCognitiveCanaryPackClient", "/v1/cognitive-canary/status", "/v1/cognitive-canary/scenarios", "/v1/cognitive-canary/evaluate", "/v1/cognitive-canary/shadow/plan", "/v1/cognitive-canary/response-collector/writeback", "/v1/cognitive-canary/reports", "/v1/cognitive-canary/evidence/", "shadowPlan", "responseCollectorWriteback", "shadow_plan_ready", "response_collector_plan_ready", "response_collector_writeback_ready", "writes_response_collector_store", "response_collectors", "response_collector_summary", "response_collector_store", "response_collector_records", "artifact_sha256", "writes_files", "judge_plan_ready", "metrics_plan_ready", "prometheus_ready", "auto_rollback_plan_ready", 'method: "POST"']) {
...
for (const token of ["TestCognitiveCanary", "StatusMethodNotAllowed", "/v1/cognitive-canary/evaluate", "/v1/cognitive-canary/shadow/plan", "/v1/cognitive-canary/response-collector/writeback"]) {
  if (!cognitiveCanaryGateTest.includes(token)) fail(`Cognitive Canary gateway gate test missing token: ${token}`);
}
for (const token of ["createCognitiveCanaryClient", "CognitiveCanaryClientError", "/v1/cognitive-canary/status", "/v1/cognitive-canary/shadow/plan", "/v1/cognitive-canary/response-collector/writeback", "/v1/cognitive-canary/evidence/", "shadowPlan", "responseCollectorWriteback", "CognitiveCanaryResponseCollectorPlan", "CognitiveCanaryResponseCollectorWritebackReport", "response_collector_plan_ready", "response_collector_writeback_ready", "writes_response_collector_store", "response_collectors", "response_collector_store", "artifact_sha256", "writes_files"]) {
  if (!cognitiveCanarySdk.includes(token)) fail(`Cognitive Canary TypeScript SDK missing token: ${token}`);
}
for (const token of ["/v1/cognitive-canary/status", "/v1/cognitive-canary/evaluate", "/v1/cognitive-canary/shadow/plan", "/v1/cognitive-canary/response-collector/writeback", "/v1/cognitive-canary/evidence/canary-1", "response_collector_summary", "response-collector-plan.json", "response-collector-store.json", "writes_response_collector_store"]) {
  if (!cognitiveCanaryClientTest.includes(token)) fail(`Cognitive Canary frontend client test missing token: ${token}`);
}
for (const token of ["json-cognitive-canary-evidence", "shadow_plan_ready", "shadow_traffic_ready", "judge_plan_ready", "judge_pipeline_ready", "response_collector_plan_ready", "response_collector_store_ready", "response_collector_writeback_ready", "writes_response_collector_store", "response_collector_ready", "canary.response_collector.plan", "canary.response_collector.writeback", "response_collectors", "response_collector_summary", "response_collector_store", "response_collector_records", "artifact_sha256", "writes_files", "metrics_plan_ready", "prometheus_ready", "quality_sli_ready", "auto_rollback_plan_ready", "auto_rollback_ready", "canary.shadow.plan", "canary.judge.plan", "canary.metrics.plan", "canary.rollback.plan", "shadow-plan.json", "response-collector-plan.json", "response-collector-store.json", "response-collector-record.json", "judge-plan.json", "metrics-plan.json", "rollback-plan.json"]) {
...
for (const token of ["createSBOMDriftPackClient", "/v1/sbom-drift/status", "/v1/sbom-drift/diff", "/v1/sbom-drift/cyclonedx/", "/v1/sbom-drift/ci-gate/plan", "/v1/sbom-drift/evidence/", "govulncheck_plan_ready", "govulncheck_plan", "writes_files", 'method: "POST"']) {
...
for (const token of ["createSBOMDriftClient", "SBOMDriftClientError", "/v1/sbom-drift/status", "/v1/sbom-drift/cyclonedx/", "/v1/sbom-drift/ci-gate/plan", "/v1/sbom-drift/evidence/", "SBOMDriftGovulncheckPlan", "govulncheck_plan_ready", "govulncheck_plan", "govulncheck-report.json", "writes_files"]) {
...
for (const token of ["createMemoryTimeTravelPackClient", "/v1/memory-time-travel/status", "/v1/memory-time-travel/snapshots", "/v1/memory-time-travel/snapshot-at", "/v1/memory-time-travel/diff", "/v1/memory-time-travel/rollback-plan", "/v1/memory-time-travel/rollback/approved-plan", "/v1/memory-time-travel/retention/plan", "/v1/memory-time-travel/retention/prune-plan", "/v1/memory-time-travel/kv-history/native-plan", "/v1/memory-time-travel/kv-history/migration-preview", "/v1/memory-time-travel/audit/links", "/v1/memory-time-travel/audit/verify", "/v1/memory-time-travel/evidence/", 'method: "POST"']) {
...
for (const token of ["TestMemoryTimeTravel", "StatusMethodNotAllowed", "/v1/memory-time-travel/diff", "/v1/memory-time-travel/rollback/approved-plan", "/v1/memory-time-travel/kv-history/native-plan", "/v1/memory-time-travel/kv-history/migration-preview"]) {
  if (!memoryTimeTravelGateTest.includes(token)) fail(`Memory Time Travel gateway gate test missing token: ${token}`);
}
for (const token of ["createMemoryTimeTravelClient", "MemoryTimeTravelClientError", "/v1/memory-time-travel/status", "/v1/memory-time-travel/rollback/approved-plan", "/v1/memory-time-travel/retention/plan", "/v1/memory-time-travel/retention/prune-plan", "/v1/memory-time-travel/kv-history/native-plan", "/v1/memory-time-travel/kv-history/migration-preview", "/v1/memory-time-travel/audit/links", "/v1/memory-time-travel/audit/verify", "/v1/memory-time-travel/evidence/", "approvedRollbackPlan", "approved_rollback_plan", "rollback_writeback_plan", "approval_request_plan", "retentionPlan", "retentionPrunePlan", "nativeKVHistoryPlan", "nativeKVHistoryMigrationPreview", "native_kv_history_plan", "kv_history_migration_plan", "kv_history_index_plan", "kv_history_migration_preview", "native_kv_history_preview_ready", "auditLinks", "auditVerify"]) {
...
for (const token of ["json-memory-time-travel-evidence", "approved-rollback-plan.json", "approved_rollback_plan", "rollback-writeback-plan.json", "rollback_writeback_plan", "approval-request-plan.json", "approval_request_plan", "approved_rollback_plan_ready", "approval_request_plan_ready", "approval_manager_bridge_plan_ready", "global_approval_enqueue_ready", "rollback_writeback_plan_ready", "writes_ledger_kv", "writes_temporal_kv", "memory.rollback.approved_plan", "memory.rollback.writeback.plan", "retention-plan.json", "retention_plan", "retention-prune-plan.json", "retention_prune_plan", "retention_plan_ready", "retention_prune_plan_ready", "retention_prune_ready", "memory.retention.plan", "memory.retention.prune_plan", "memory.kv_history.native_plan", "memory.kv_history.migration_preview", "native-kv-history-plan.json", "native_kv_history_plan", "kv-history-migration-plan.json", "kv_history_migration_plan", "kv-history-index-plan.json", "kv_history_index_plan", "kv-history-migration-preview.json", "kv_history_migration_preview", "native_kv_history_plan_ready", "kv_history_migration_plan_ready", "kv_history_index_plan_ready", "native_kv_history_preview_ready", "native_kv_history_ready", "writes_native_kv_history", "migrates_kv_history", "max_snapshots_per_namespace", "audit-links.json", "kv_audit_link_schema", "kv_audit_links", "kv_audit_link_schema_ready", "kv_audit_linkage_ready", "memory.audit.links.schema", "audit-verification.json", "audit_verification", "snapshot_store_ready", "temporal_query_ready", "ledger_history_ready", "memory_persister_writeback_ready", "TemporalKVReader", "SnapshotRawAt", "NativeKVHistoryPreviewer", "PreviewNativeKVHistoryRows", "ledger-kv-history", "merkle_verification_ready", "memory.audit.verify", "MerkleVerifier", "VerifyMerkleAuditChain", "rollback_writeback_ready"]) {
