...
for (const token of ["createWASMPluginPackClient", "/v1/wasm-plugin/status", "/v1/wasm-plugin/execute", "/v1/wasm-plugin/remote-install/plan", "/v1/wasm-plugin/remote-install/approval/plan", "/v1/wasm-plugin/remote-install/approval/decision/plan", "/v1/wasm-plugin/remote-install/approval/writeback/plan", "/v1/wasm-plugin/remote-install/approval/queue/writeback", "/v1/wasm-plugin/remote-install/installer/continuation/plan", "/v1/wasm-plugin/evidence/", "remoteInstallPlan", "remoteInstallApprovalPlan", "remoteInstallApprovalDecisionPlan", "remoteInstallApprovalWritebackPlan", "remoteInstallApprovalQueueWriteback", "remoteInstallInstallerContinuationPlan", "WASMPluginRemoteInstallPlan", "WASMPluginRemoteInstallApprovalPlan", "WASMPluginRemoteInstallApprovalDecisionPlan", "WASMPluginRemoteInstallApprovalWritebackPlan", "WASMPluginRemoteInstallApprovalQueueWriteback", "WASMPluginRemoteInstallInstallerContinuationPlan", "WASMPluginInstallerContinuationPlan", "WASMPluginApprovalQueueRecord", "WASMPluginApprovalQueueStoreSummary", "WASMPluginApprovalDecisionPlan", "WASMPluginApprovalWritebackPlan", "WASMPluginSignatureVerificationPlan", "remote_install_plan", "signature_verification", "approval_gate_plan", "approval_decision_plan", "approval_writeback_plan", 'method: "POST"']) {
