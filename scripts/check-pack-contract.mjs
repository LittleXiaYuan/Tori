...
for (const token of ["createMemoryTimeTravelPackClient", "/v1/memory-time-travel/status", "/v1/memory-time-travel/snapshots", "/v1/memory-time-travel/snapshot-at", "/v1/memory-time-travel/diff", "/v1/memory-time-travel/rollback-plan", "/v1/memory-time-travel/rollback/approved-plan", "/v1/memory-time-travel/retention/plan", "/v1/memory-time-travel/retention/prune-plan", "/v1/memory-time-travel/kv-history/native-plan", "/v1/memory-time-travel/kv-history/migration-preview", "/v1/memory-time-travel/kv-history/dual-read/parity", "/v1/memory-time-travel/kv-history/cutover/plan", "/v1/memory-time-travel/kv-history/cutover/readiness", "/v1/memory-time-travel/audit/links", "/v1/memory-time-travel/audit/links/preview", "/v1/memory-time-travel/audit/links/writeback-plan", "/v1/memory-time-travel/audit/links/writeback/store", "/v1/memory-time-travel/audit/verify", "/v1/memory-time-travel/evidence/", "auditLinksWritebackPlan", "auditLinksWritebackStore", 'method: "POST"']) {
...
for (const token of ["TestMemoryTimeTravel", "StatusMethodNotAllowed", "/v1/memory-time-travel/diff", "/v1/memory-time-travel/rollback/approved-plan", "/v1/memory-time-travel/kv-history/native-plan", "/v1/memory-time-travel/kv-history/migration-preview", "/v1/memory-time-travel/kv-history/dual-read/parity", "/v1/memory-time-travel/kv-history/cutover/plan", "/v1/memory-time-travel/kv-history/cutover/readiness", "/v1/memory-time-travel/audit/links/preview", "/v1/memory-time-travel/audit/links/writeback-plan", "/v1/memory-time-travel/audit/links/writeback/store"]) {
  if (!memoryTimeTravelGateTest.includes(token)) fail(`Memory Time Travel gateway gate test missing token: ${token}`);
}
for (const token of ["createMemoryTimeTravelClient", "MemoryTimeTravelClientError", "/v1/memory-time-travel/status", "/v1/memory-time-travel/rollback/approved-plan", "/v1/memory-time-travel/retention/plan", "/v1/memory-time-travel/retention/prune-plan", "/v1/memory-time-travel/kv-history/native-plan", "/v1/memory-time-travel/kv-history/migration-preview", "/v1/memory-time-travel/kv-history/dual-read/parity", "/v1/memory-time-travel/kv-history/cutover/plan", "/v1/memory-time-travel/kv-history/cutover/readiness", "/v1/memory-time-travel/audit/links", "/v1/memory-time-travel/audit/links/preview", "/v1/memory-time-travel/audit/links/writeback-plan", "/v1/memory-time-travel/audit/links/writeback/store", "/v1/memory-time-travel/audit/verify", "/v1/memory-time-travel/evidence/", "approvedRollbackPlan", "approved_rollback_plan", "rollback_writeback_plan", "approval_request_plan", "retentionPlan", "retentionPrunePlan", "nativeKVHistoryPlan", "nativeKVHistoryMigrationPreview", "kvHistoryDualReadParity", "kvHistoryCutoverPlan", "kvHistoryCutoverReadiness", "auditLinksPreview", "native_kv_history_plan", "kv_history_migration_plan", "kv_history_index_plan", "kv_history_migration_preview", "kv_history_dual_read_parity", "native_kv_history_preview_ready", "kv_history_cutover_plan", "kv_history_cutover_readiness", "kv_history_dual_read_plan", "kv_history_dual_write_plan", "kv_history_cutover_plan_ready", "kv_history_cutover_readiness_ready", "cutover_readiness_check_ready", "dual_read_plan_ready", "dual_read_parity_check_ready", "dual_read_parity_ready", "parity_passed", "dual_write_plan_ready", "cutover_ready", "auditLinks", "auditLinksPreview", "auditLinksWritebackPlan", "auditLinksWritebackStore", "auditVerify", "kv_audit_link_writeback_plan", "kv_audit_link_writeback_actions", "kv_audit_link_writeback_store", "kv_audit_link_writeback_records", "kv_audit_link_writeback_plan_ready", "kv_audit_link_writeback_store_ready", "kv_audit_link_writeback_ready", "writes_audit_link_writeback_store", "backfills_audit_seq", "backfills_audit_hash", "consumes_audit_link_preview"]) {
