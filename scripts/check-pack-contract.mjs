...
for (const token of ["createMemoryTimeTravelPackClient", "/v1/memory-time-travel/status", "/v1/memory-time-travel/snapshots", "/v1/memory-time-travel/snapshot-at", "/v1/memory-time-travel/diff", "/v1/memory-time-travel/rollback-plan", "/v1/memory-time-travel/rollback/approved-plan", "/v1/memory-time-travel/retention/plan", "/v1/memory-time-travel/retention/prune-plan", "/v1/memory-time-travel/kv-history/native-plan", "/v1/memory-time-travel/kv-history/migration-preview", "/v1/memory-time-travel/kv-history/cutover/plan", "/v1/memory-time-travel/audit/links", "/v1/memory-time-travel/audit/verify", "/v1/memory-time-travel/evidence/", 'method: "POST"']) {
...
for (const token of ["TestMemoryTimeTravel", "StatusMethodNotAllowed", "/v1/memory-time-travel/diff", "/v1/memory-time-travel/rollback/approved-plan", "/v1/memory-time-travel/kv-history/native-plan", "/v1/memory-time-travel/kv-history/migration-preview", "/v1/memory-time-travel/kv-history/cutover/plan"]) {
  if (!memoryTimeTravelGateTest.includes(token)) fail(`Memory Time Travel gateway gate test missing token: ${token}`);
}
for (const token of ["createMemoryTimeTravelClient", "MemoryTimeTravelClientError", "/v1/memory-time-travel/status", "/v1/memory-time-travel/rollback/approved-plan", "/v1/memory-time-travel/retention/plan", "/v1/memory-time-travel/retention/prune-plan", "/v1/memory-time-travel/kv-history/native-plan", "/v1/memory-time-travel/kv-history/migration-preview", "/v1/memory-time-travel/kv-history/cutover/plan", "/v1/memory-time-travel/audit/links", "/v1/memory-time-travel/audit/verify", "/v1/memory-time-travel/evidence/", "approvedRollbackPlan", "approved_rollback_plan", "rollback_writeback_plan", "approval_request_plan", "retentionPlan", "retentionPrunePlan", "nativeKVHistoryPlan", "nativeKVHistoryMigrationPreview", "kvHistoryCutoverPlan", "native_kv_history_plan", "kv_history_migration_plan", "kv_history_index_plan", "kv_history_migration_preview", "native_kv_history_preview_ready", "kv_history_cutover_plan", "kv_history_dual_read_plan", "kv_history_dual_write_plan", "kv_history_cutover_plan_ready", "dual_read_plan_ready", "dual_write_plan_ready", "cutover_ready", "auditLinks", "auditVerify"]) {
  if (!memoryTimeTravelSdk.includes(token)) fail(`Memory Time Travel TypeScript SDK missing token: ${token}`);
}
for (const token of ["/v1/memory-time-travel/status", "/v1/memory-time-travel/diff", "/v1/memory-time-travel/rollback/approved-plan", "/v1/memory-time-travel/retention/plan?namespace=memory_snapshot", "/v1/memory-time-travel/retention/prune-plan", "/v1/memory-time-travel/kv-history/native-plan?namespace=memory_snapshot", "/v1/memory-time-travel/kv-history/migration-preview?namespace=memory_snapshot&limit=50", "/v1/memory-time-travel/kv-history/cutover/plan", "/v1/memory-time-travel/audit/links?namespace=memory_snapshot", "/v1/memory-time-travel/audit/verify?limit=3", "/v1/memory-time-travel/evidence/baseline"]) {
  if (!memoryTimeTravelClientTest.includes(token)) fail(`Memory Time Travel frontend client test missing token: ${token}`);
}
for (const token of ["json-memory-time-travel-evidence", "approved-rollback-plan.json", "approved_rollback_plan", "rollback-writeback-plan.json", "rollback_writeback_plan", "approval-request-plan.json", "approval_request_plan", "approved_rollback_plan_ready", "approval_request_plan_ready", "approval_manager_bridge_plan_ready", "global_approval_enqueue_ready", "rollback_writeback_plan_ready", "writes_ledger_kv", "writes_temporal_kv", "memory.rollback.approved_plan", "memory.rollback.writeback.plan", "retention-plan.json", "retention_plan", "retention-prune-plan.json", "retention_prune_plan", "retention_plan_ready", "retention_prune_plan_ready", "retention_prune_ready", "memory.retention.plan", "memory.retention.prune_plan", "memory.kv_history.native_plan", "memory.kv_history.migration_preview", "memory.kv_history.cutover.plan", "native-kv-history-plan.json", "native_kv_history_plan", "kv-history-migration-plan.json", "kv_history_migration_plan", "kv-history-index-plan.json", "kv_history_index_plan", "kv-history-migration-preview.json", "kv_history_migration_preview", "kv-history-cutover-plan.json", "kv-history-dual-read-plan.json", "kv-history-dual-write-plan.json", "kv_history_cutover_plan", "kv_history_dual_read_plan", "kv_history_dual_write_plan", "kv_history_cutover_plan_ready", "dual_read_plan_ready", "dual_write_plan_ready", "dual_read_ready", "dual_write_ready", "cutover_ready", "switches_temporal_adapter", "native_kv_history_plan_ready", "kv_history_migration_plan_ready", "kv_history_index_plan_ready", "native_kv_history_preview_ready", "native_kv_history_ready", "writes_native_kv_history", "migrates_kv_history", "max_snapshots_per_namespace", "audit-links.json", "kv_audit_link_schema", "kv_audit_links", "kv_audit_link_schema_ready", "kv_audit_linkage_ready", "memory.audit.links.schema", "audit-verification.json", "audit_verification", "snapshot_store_ready", "temporal_query_ready", "ledger_history_ready", "memory_persister_writeback_ready", "TemporalKVReader", "SnapshotRawAt", "NativeKVHistoryPreviewer", "PreviewNativeKVHistoryRows", "ledger-kv-history", "merkle_verification_ready", "memory.audit.verify", "MerkleVerifier", "VerifyMerkleAuditChain", "rollback_writeback_ready"]) {
