...
for (const token of ["createWASMPluginPackClient", "/v1/wasm-plugin/status", "/v1/wasm-plugin/execute", "/v1/wasm-plugin/remote-install/plan", "/v1/wasm-plugin/remote-install/approval/plan", "/v1/wasm-plugin/remote-install/approval/decision/plan", "/v1/wasm-plugin/evidence/", "remoteInstallPlan", "remoteInstallApprovalPlan", "remoteInstallApprovalDecisionPlan", "WASMPluginRemoteInstallPlan", "WASMPluginRemoteInstallApprovalPlan", "WASMPluginRemoteInstallApprovalDecisionPlan", "WASMPluginApprovalDecisionPlan", "WASMPluginSignatureVerificationPlan", "remote_install_plan", "signature_verification", "approval_gate_plan", "approval_decision_plan", 'method: "POST"']) {
...
for (const token of ["TestWASMPlugin", "StatusNotFound", "StatusMethodNotAllowed", "/v1/wasm-plugin/execute", "/v1/wasm-plugin/remote-install/plan", "/v1/wasm-plugin/remote-install/approval/plan", "/v1/wasm-plugin/remote-install/approval/decision/plan"]) {
  if (!wasmPluginGateTest.includes(token)) fail(`WASM Plugin gateway gate test missing token: ${token}`);
}
for (const token of ["createWASMPluginClient", "WASMPluginClientError", "/v1/wasm-plugin/status", "/v1/wasm-plugin/remote-install/plan", "/v1/wasm-plugin/remote-install/approval/plan", "/v1/wasm-plugin/remote-install/approval/decision/plan", "/v1/wasm-plugin/evidence/", "remoteInstallPlan", "remoteInstallApprovalPlan", "remoteInstallApprovalDecisionPlan", "WASMPluginRemoteInstallPlan", "WASMPluginRemoteInstallApprovalPlan", "WASMPluginRemoteInstallApprovalDecisionPlan", "WASMPluginSignatureVerificationPlan", "WASMPluginApprovalQueueEntryPlan", "WASMPluginApprovalDecisionPlan", "remote_install_plan", "signature_verification", "approval_queue_entry", "approval_gate_plan", "approval_decision_plan"]) {
