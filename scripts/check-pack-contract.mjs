...
for (const token of ["createWASMPluginClient", "WASMPluginClientError", "/v1/wasm-plugin/status", "/v1/wasm-plugin/remote-install/plan", "/v1/wasm-plugin/remote-install/approval/plan", "/v1/wasm-plugin/evidence/", "remoteInstallPlan", "remoteInstallApprovalPlan", "WASMPluginRemoteInstallPlan", "WASMPluginRemoteInstallApprovalPlan", "WASMPluginSignatureVerificationPlan", "WASMPluginApprovalQueueEntryPlan", "remote_install_plan", "signature_verification", "approval_queue_entry", "approval_gate_plan"]) {
