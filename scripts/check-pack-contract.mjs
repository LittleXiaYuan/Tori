...
for (const token of ["createMemoryTimeTravelPackClient", "/v1/memory-time-travel/status", "/v1/memory-time-travel/snapshots", "/v1/memory-time-travel/snapshot-at", "/v1/memory-time-travel/diff", "/v1/memory-time-travel/rollback-plan", "/v1/memory-time-travel/retention/plan", "/v1/memory-time-travel/retention/prune-plan", "/v1/memory-time-travel/audit/links", "/v1/memory-time-travel/audit/verify", "/v1/memory-time-travel/evidence/", 'method: "POST"']) {
...
for (const token of ["createMemoryTimeTravelClient", "MemoryTimeTravelClientError", "/v1/memory-time-travel/status", "/v1/memory-time-travel/retention/plan", "/v1/memory-time-travel/retention/prune-plan", "/v1/memory-time-travel/audit/links", "/v1/memory-time-travel/audit/verify", "/v1/memory-time-travel/evidence/", "retentionPlan", "retentionPrunePlan", "auditLinks", "auditVerify"]) {
...
for (const token of ["createWASMPluginPackClient", "/v1/wasm-plugin/status", "/v1/wasm-plugin/execute", "/v1/wasm-plugin/remote-install/plan", "/v1/wasm-plugin/remote-install/approval/plan", "/v1/wasm-plugin/remote-install/approval/decision/plan", "/v1/wasm-plugin/remote-install/approval/writeback/plan", "/v1/wasm-plugin/evidence/", "remoteInstallPlan", "remoteInstallApprovalPlan", "remoteInstallApprovalDecisionPlan", "remoteInstallApprovalWritebackPlan", "WASMPluginRemoteInstallPlan", "WASMPluginRemoteInstallApprovalPlan", "WASMPluginRemoteInstallApprovalDecisionPlan", "WASMPluginRemoteInstallApprovalWritebackPlan", "WASMPluginApprovalDecisionPlan", "WASMPluginApprovalWritebackPlan", "WASMPluginSignatureVerificationPlan", "remote_install_plan", "signature_verification", "approval_gate_plan", "approval_decision_plan", "approval_writeback_plan", 'method: "POST"']) {
...
for (const token of ["approval_writeback_plan_ready", "approval_writeback_ready", "approval_writeback_plan", "approval-writeback-plan.json", "installer_blocked_until_writeback", "writeback_store", "remoteInstallApprovalWritebackPlan"]) {
...
for (const token of ["createWASMPluginClient", "WASMPluginClientError", "/v1/wasm-plugin/status", "/v1/wasm-plugin/remote-install/plan", "/v1/wasm-plugin/remote-install/approval/plan", "/v1/wasm-plugin/remote-install/approval/decision/plan", "/v1/wasm-plugin/remote-install/approval/writeback/plan", "/v1/wasm-plugin/evidence/", "remoteInstallPlan", "remoteInstallApprovalPlan", "remoteInstallApprovalDecisionPlan", "remoteInstallApprovalWritebackPlan", "WASMPluginRemoteInstallPlan", "WASMPluginRemoteInstallApprovalPlan", "WASMPluginRemoteInstallApprovalDecisionPlan", "WASMPluginRemoteInstallApprovalWritebackPlan", "WASMPluginSignatureVerificationPlan", "WASMPluginApprovalQueueEntryPlan", "WASMPluginApprovalDecisionPlan", "WASMPluginApprovalWritebackPlan", "remote_install_plan", "signature_verification", "approval_queue_entry", "approval_gate_plan", "approval_decision_plan", "approval_writeback_plan"]) {
