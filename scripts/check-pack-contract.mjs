...
for (const token of ["abi_plan_ready", "host_abi_plan", "WASMPluginHostABIPlan", "host_abi_gate", "WASMPluginHostABIExecutionGate", "host_abi_execution_gate_ready", "host_abi_enforcement_ready", "execution_gate_ready", "allows_execution", "blocked_until_host_abi_enforcement", "enforcement_ready", "writes_files"]) {
...
for (const token of ["WASMPluginHostABIPlan", "WASMPluginHostABIExecutionGate", "host_abi_plan", "host_abi_gate", "host_abi_execution_gate_ready", "host_abi_enforcement_ready", "execution_gate_ready", "allows_execution", "enforcement_ready", "writes_files"]) {
