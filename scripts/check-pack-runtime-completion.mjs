...
requireTokens("后端 backend pack module registry / route gates", backend + gateway, [
  ...
  "Methods: methods",
  "handlePackCapabilities",
  "packCapabilityIndexReport",
  "/v1/packs/capabilities",
  "CapabilityResolveReport",
  "handlePackCapabilityResolve",
  "packCapabilityResolveReport",
  "/v1/packs/capabilities/resolve",
  "CapabilityGateReport",
  "handlePackCapabilityGate",
  "packCapabilityGateReport",
  "/v1/packs/capabilities/gate",
  "CapabilityPlanReport",
  "handlePackCapabilityPlan",
  "packCapabilityPlanReport",
  "/v1/packs/capabilities/plan",
  "CapabilityPrepareReport",
