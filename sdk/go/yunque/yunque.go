...
func (p *pluginFilesNamespace) Files(ctx context.Context, name string) (PluginsResponse, error) {
	return Plugins.Files(ctx, name)
}
...
func (s *skillsSuggestionsNamespace) Suggestions(ctx context.Context, sessionID string) (SkillsResponse, error) {
	return Skills.Suggestions(ctx, sessionID)
}
...
// PluginKnowledge exposes standalone plugin-scoped knowledge/RAG helpers for plugins and scripts.
var PluginKnowledge = &pluginKnowledgeNamespace{}
...
func (p *pluginKnowledgeNamespace) Ingest(ctx context.Context, content, filename string) error {
