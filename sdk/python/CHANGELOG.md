...
- State Kernel helpers (snapshot, goals, actions, capabilities, focus, resources)
- Reflection Experience helpers (experiences, stats, strategies)
- Mission Parse helpers for natural-language intent parsing
- Scheduler helpers for prompt-based recurring jobs
- Cron System helpers for host-level scheduled tasks
- Memory Kernel helpers for host recall memory layer
- Knowledge Graph helpers for entity and relationship management
- Knowledge Base helpers for RAG knowledge repository
- LoRA lifecycle helpers for local brain training
- Workflow orchestration helpers
- Connectors runtime helpers for external service integration
- Notify runtime helpers for notification channels
- Triggers automation helpers for event-driven workflows
...
- Breaker SDK for circuit breaker reset
