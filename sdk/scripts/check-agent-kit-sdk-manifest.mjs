...
const requiredCapabilities = ["state", "reflect", "missions", "scheduler", "cron", "triggers", "memory", "graph", "knowledge", "lora", "workflows", "connectors", "notify", "projects", "market", "skillhub", "plugins", "pluginUI", "pluginToggle", "pluginReload", "pluginFiles", "pluginFolder", "pluginSearch", "pluginSend", "skillsCatalog", "skillsScan", "skillsSuggestions", "skillsDynamic", "skills", "dispatch", "orchestrator", "fork", "cost", "providers", "breaker", "models", "router", "cognis", "trace", "heartbeat", "events", "runtime", "runtimeQueue", "subagents", "tools", "sandbox", "audit", "trust", "skillgrow", "review", "iterate", "persona", "modes", "emotion", "instructions", "reactions", "interactions", "permissions", "tori", "upload", "speech", "setup", "admin", "federation", "planner", "ide", "discovery", "identity", "embeddings", "search", "auth", "tasks", "documents", "bots", "reverie", "chat", "webchat", "conversations", "approvals", "rbac", "files", "browser", "realtime", "plugin", "airi"];
...
for (const [language, config] of Object.entries(languages)) {
  ...
  for (const token of ["Agent Kit", "State", "Reflect", "Mission", "Scheduler", "Cron", "Trigger", "Memory", "Graph", "Knowledge", "LoRA", "Workflow", "Connector", "Notify", "Projects", "Market", "SkillHub", "Plugins", "PluginToggle", "PluginReload", "PluginFiles", "PluginFolder", "PluginSearch", "PluginSend", "PluginUI", "SkillsCatalog", "SkillsScan", "SkillsSuggestions", "SkillsDynamic", "Skills", "Dispatch", "Orchestrator", "Fork", "Cost", "Provider", "Breaker", "Models", "Router", "Cogni", "Trace", "Heartbeat", "Events", "Runtime", "RuntimeQueue", "Subagents", "Tools", "Sandbox", "Audit", "Trust", "SkillGrow", "Review", "Iterate", "Persona", "Modes", "Emotion", "Instructions", "Reactions", "Interactions", "Permissions", "Tori", "Upload", "Speech", "Setup", "Admin", "Federation", "Planner", "IDE", "Discovery", "Identity", "Embeddings", "Search", "Auth", "Tasks", "Documents", "Bots", "Reverie", "Chat", "WebChat", "Conversation", "Approval", "RBAC", "Files", "Browser", "Realtime", "Plugin", "Airi"]) {
