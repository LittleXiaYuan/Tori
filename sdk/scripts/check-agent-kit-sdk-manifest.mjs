...
const requiredCapabilities = ["state", "reflect", "missions", "scheduler", "cron", "triggers", "memory", "graph", "knowledge", "lora", "workflows", "connectors", "notify", "projects", "market", "skillhub", "plugins", "skills", "dispatch", "orchestrator", "fork", "cost", "providers", "models", "router", "cognis", "trace", "heartbeat", "events", "runtime", "subagents", "tools", "sandbox", "audit", "trust", "iterate", "persona", "emotion", "instructions", "reactions", "permissions", "tori", "speech", "setup", "admin", "federation", "planner", "ide", "discovery", "identity", "embeddings", "auth", "tasks", "documents", "bots", "reverie", "chat", "webchat", "conversations", "approvals", "rbac", "files", "browser", "realtime", "plugin"];
...
for (const [language, config] of Object.entries(languages)) {
  ...
  for (const token of ["Agent Kit", "State", "Reflect", "Mission", "Scheduler", "Cron", "Trigger", "Memory", "Graph", "Knowledge", "LoRA", "Workflow", "Connector", "Notify", "Projects", "Market", "SkillHub", "Plugins", "Skills", "Dispatch", "Orchestrator", "Fork", "Cost", "Provider", "Models", "Router", "Cogni", "Trace", "Heartbeat", "Events", "Runtime", "Subagents", "Tools", "Sandbox", "Audit", "Trust", "Iterate", "Persona", "Emotion", "Instructions", "Reactions", "Permissions", "Tori", "Speech", "Setup", "Admin", "Federation", "Planner", "IDE", "Discovery", "Identity", "Embeddings", "Auth", "Tasks", "Documents", "Bots", "Reverie", "Chat", "WebChat", "Conversation", "Approval", "RBAC", "Files", "Browser", "Realtime", "Plugin"]) {
