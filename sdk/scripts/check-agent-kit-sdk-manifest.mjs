...
const requiredCapabilities = ["state", "reflect", "missions", "scheduler", "cron", "triggers", "memory", "graph", "knowledge", "lora", "workflows", "connectors", "notify", "projects", "market", "dispatch", "orchestrator", "fork", "cost", "providers", "cognis", "trace", "heartbeat", "events", "runtime", "subagents", "tools", "audit", "trust", "iterate", "persona", "emotion", "instructions", "reactions", "permissions", "auth", "tasks", "reverie", "chat", "conversations", "approvals", "rbac", "files", "browser", "realtime", "plugin"];
...
for (const [language, config] of Object.entries(languages)) {
  ...
  for (const token of ["Agent Kit", "State", "Reflect", "Mission", "Scheduler", "Cron", "Trigger", "Memory", "Graph", "Knowledge", "LoRA", "Workflow", "Connector", "Notify", "Projects", "Market", "Dispatch", "Orchestrator", "Fork", "Cost", "Provider", "Cogni", "Trace", "Heartbeat", "Events", "Runtime", "Subagents", "Tools", "Audit", "Trust", "Iterate", "Persona", "Emotion", "Instructions", "Reactions", "Permissions", "Auth", "Tasks", "Reverie", "Chat", "Conversation", "Approval", "RBAC", "Files", "Browser", "Realtime", "Plugin"]) {
