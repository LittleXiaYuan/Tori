...
const requiredCapabilities = ["state", "reflect", "missions", "scheduler", "cron", "triggers", "memory", "graph", "knowledge", "lora", "workflows", "connectors", "notify", "projects", "market", "dispatch", "orchestrator", "fork", "cost", "providers", "cognis", "trace", "heartbeat", "reverie", "plugin"];
...
for (const [language, config] of Object.entries(languages)) {
  ...
  for (const token of ["Agent Kit", "State", "Reflect", "Mission", "Scheduler", "Cron", "Trigger", "Memory", "Graph", "Knowledge", "LoRA", "Workflow", "Connector", "Notify", "Projects", "Market", "Dispatch", "Orchestrator", "Fork", "Cost", "Provider", "Cogni", "Trace", "Heartbeat", "Reverie", "Plugin"]) {
