...
const requiredCapabilities = ["list", "catalog", "releaseCatalog", "installed", "enabled", "capabilities", "resolveCapability", "gateCapability", "planCapabilities", "prepareCapabilities", "backendModules", "backendRouteAudit", "install", "enable", "disable", "rollback", "prune", "frontendSync", "routeBinding"];
const requiredRoutes = ["GET /v1/packs", "GET /v1/packs/catalog", "POST /v1/packs/release-catalog", "GET /v1/packs/installed", "GET /v1/packs/enabled", "GET /v1/packs/capabilities", "GET /v1/packs/capabilities/resolve", "GET /v1/packs/capabilities/gate", "GET /v1/packs/capabilities/plan", "GET /v1/packs/capabilities/prepare", "GET /v1/packs/backend-modules", "GET /v1/packs/backend-route-audit", "POST /v1/packs/install", "POST /v1/packs/enable", "POST /v1/packs/disable", "POST /v1/packs/rollback", "POST /v1/packs/prune"];
...
for (const token of ["summarizeCatalogSourceReports", "hasCatalogSourceIssues", "summarizeCapabilityPrepare", "maxUnpackedGrowthPerPackSdkHelperExport", "maxUnpackedGrowthForPackPrepareSummaryHelperExport"]) {
  if (!sdkPackCheck.includes(token) && !packsSource.includes(token) && !JSON.stringify(manifest).includes(token)) fail(`Packs SDK helper contract missing token: ${token}`);
}
