...
for (const token of ["Manifest", "Registry", "BackendModule", "BackendRoute", "Method  string", "BackendModuleInfo", "BackendRouteInfo", "method,omitempty", "frontend", "menus", "routes", "sdk", "DistributionManifest", "PackArtifacts", "PreviousArtifacts", "CacheDistribution", "InstallWithArtifacts", "packageUrl", "frontendUrl", "sha256", "rollback"]) if (!packContract.includes(token)) fail(`pack runtime contract missing token: ${token}`);
