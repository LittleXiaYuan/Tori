...
const requiredCapabilities = ["list", "installed", "enabled", "capabilities", "backendModules", "backendRouteAudit", "install", "enable", "disable", "rollback", "prune", "frontendSync", "routeBinding"];
const requiredRoutes = ["GET /v1/packs", "GET /v1/packs/installed", "GET /v1/packs/enabled", "GET /v1/packs/capabilities", "GET /v1/packs/backend-modules", "GET /v1/packs/backend-route-audit", "POST /v1/packs/install", "POST /v1/packs/enable", "POST /v1/packs/disable", "POST /v1/packs/rollback", "POST /v1/packs/prune"];
...
for (const route of ['"/v1/packs"', '"/v1/packs/installed"', '"/v1/packs/enabled"', '"/v1/packs/capabilities"', '"/v1/packs/backend-modules"', '"/v1/packs/backend-route-audit"', '"/v1/packs/install"', '"/v1/packs/enable"', '"/v1/packs/disable"', '"/v1/packs/rollback"']) if (!gateway.includes(route)) fail(`gateway route not found: ${route}`);
for (const handler of ["handlePacksList", "handlePacksEnabled", "handlePackCapabilities", "packCapabilityIndexReport", "CapabilityIndexReport", "CapabilityIndexEntry", "handlePackBackendModules", "handlePackBackendRouteAudit", "backendRouteAuditReport", "handlePackInstall", "handlePackEnable", "handlePackDisable", "handlePackRollback", "RegisterBackendPack", "registerBackendPack", "requirePackRoute", "backendPackRouteInfos", "BackendRouteInfo{Method", "Methods: methods", "normalizeBackendRouteMethods", "must declare an HTTP method"]) if (!gateway.includes(handler) && !packContract.includes(handler)) fail(`pack runtime gateway contract not found: ${handler}`);
for (const token of ["Manifest", "Registry", "BackendModule", "BackendRoute", "Method  string", "Methods []string", "BackendRouteSpec", "routeSpecs", "AllowsRoute", "BackendModuleInfo", "BackendRouteInfo", "CapabilityIndexReport", "CapabilityIndexEntry", "json:\"enabled_capabilities", "json:\"sdk_typescript", "BackendRouteAuditReport", "BackendRouteAuditEntry", "json:\"methods,omitempty\"", "frontend", "menus", "routes", "sdk", "DistributionManifest", "PackArtifacts", "PreviousArtifacts", "PruneArtifacts", "CacheDistribution", "InstallWithArtifacts", "packageUrl", "frontendUrl", "sha256", "rollback"]) if (!packContract.includes(token)) fail(`pack runtime contract missing token: ${token}`);
