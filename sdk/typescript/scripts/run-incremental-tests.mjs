...
const sources = [
  ...
  "src/memory-add.ts",
  "src/memory-add.test.ts",
  "src/memory-compact.ts",
  "src/memory-compact.test.ts",
  "src/tasks.ts",
  "src/tasks.test.ts",
  "src/task-context.ts",
...
for (const testName of [
  ...
  compiledTest = compiledTest
    ...
    .replace('from "./memory-add"', 'from "./memory-add.js"')
    ...
    .replace('from "./task-delete"', 'from "./task-delete.js"')
