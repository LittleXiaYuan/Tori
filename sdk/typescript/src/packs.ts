...
export type PackCatalogEntry = { manifest_path?: string; source?: string; manifest: PackManifest; installed: boolean; enabled: boolean; status?: PackStatus; update_action: "use" | "enable" | "install" | "update" | string; downloadable: boolean; [key: string]: unknown };
export type PackCatalogReport = { generated_at: string; sources: string[]; count: number; installed: number; enabled: number; downloadable: number; capabilities: number; capability?: string; query?: string; entries: PackCatalogEntry[]; install_hints?: PackCatalogEntry[]; enable_hints?: PackCatalogEntry[]; download_hints?: PackCatalogEntry[]; errors?: string[]; [key: string]: unknown };
...
export type PackCapabilityPrepareReport = { generated_at: string; capabilities: string[]; allowed: boolean; action: "use" | "enable" | "install" | "fix-route-audit" | string; plan: PackCapabilityPlanReport; use_steps?: PackCapabilityPrepareStep[]; enable_steps?: PackCapabilityPrepareStep[]; install_steps?: PackCapabilityPrepareStep[]; download_steps?: PackCapabilityPrepareStep[]; route_audit_fix_steps?: PackCapabilityPrepareStep[]; steps: PackCapabilityPrepareStep[]; step_count: number; download_count: number; enable_count: number; install_count: number; route_audit_issue_count: number; ready_count: number; unavailable_reasons?: string[]; route_audit_issues?: PackBackendRouteAuditEntry[]; [key: string]: unknown };
