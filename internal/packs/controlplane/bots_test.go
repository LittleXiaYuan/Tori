...
func (g *botGateway) ReviewGate() *review.Gate { return nil }

func (g *botGateway) Distiller() *distill.Distiller { return nil }

func (g *botGateway) SkillGrowDetector() *adapter.Detector { return nil }

func (g *botGateway) IterateEngine() *iterate.Engine { return nil }
