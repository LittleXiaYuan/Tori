...
func (g *tenantGateway) AuditChain() *audit.Chain { return nil }

func (g *tenantGateway) AuditTrail() *audit.Trail { return nil }

func (g *tenantGateway) BotManager() *bots.Manager { return nil }

func (g *tenantGateway) InboxStore() *inbox.Store { return nil }

func (g *tenantGateway) ShellPolicy() *tools.ShellExecPolicy { return nil }
...
func (g *tenantGateway) ToolsManager() *tools.ProcessManager { return nil }

func (g *tenantGateway) TrustTracker() *trust.Tracker { return nil }

func (g *tenantGateway) RoleOf(ctx context.Context) string { return "user" }

func (g *tenantGateway) ReviewGate() *review.Gate { return nil }

func (g *tenantGateway) Distiller() *distill.Distiller { return nil }

func (g *tenantGateway) SkillGrowDetector() *adapter.Detector { return nil }

func (g *tenantGateway) IterateEngine() *iterate.Engine { return nil }

func (g *tenantGateway) OutputDir() string { return "" }
...
func (g *tenantGateway) UsageSnapshot(ctx context.Context) any { return nil }

func (g *tenantGateway) SetUsageQuota(ctx context.Context, tenantID string, maxChatCalls, maxTokensPerDay int64) {
}
