...
func (g *modelsGateway) AuditChain() *audit.Chain { return nil }

func (g *modelsGateway) AuditTrail() *audit.Trail { return nil }
...
func (g *modelsGateway) TrustTracker() *trust.Tracker { return nil }

func (g *modelsGateway) RoleOf(ctx context.Context) string { return "user" }

func (g *modelsGateway) ReviewGate() *review.Gate { return nil }
