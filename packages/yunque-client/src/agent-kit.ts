...
import { createPluginToggleClient, type PluginToggleClient, type PluginToggleClientOptions } from "./plugin-toggle.js";
import { createPluginReloadClient, type PluginReloadClient, type PluginReloadClientOptions } from "./plugin-reload.js";
import { createPluginFilesClient, type PluginFilesClient, type PluginFilesClientOptions } from "./plugin-files.js";
import { createPluginFolderClient, type PluginFolderClient, type PluginFolderClientOptions } from "./plugin-folder.js";
import { createPluginSearchClient, type PluginSearchClient, type PluginSearchClientOptions } from "./plugin-search.js";
import { createPluginSendClient, type PluginSendClient, type PluginSendClientOptions } from "./plugin-send.js";
import { createPluginLLMClient, type PluginLLMClient, type PluginLLMClientOptions } from "./plugin-llm.js";
import { createPluginMemoryClient, type PluginMemoryClient, type PluginMemoryClientOptions } from "./plugin-memory.js";
import { createPluginKnowledgeClient, type PluginKnowledgeClient, type PluginKnowledgeClientOptions } from "./plugin-knowledge.js";
import { createPluginAgentMemoryClient, type PluginAgentMemoryClient, type PluginAgentMemoryClientOptions } from "./plugin-agent-memory.js";
import { createPluginCronClient, type PluginCronClient, type PluginCronClientOptions } from "./plugin-cron.js";
import { createPluginExtensionsClient, type PluginExtensionsClient, type PluginExtensionsClientOptions } from "./plugin-extensions.js";
...
import { createSkillsDynamicClient, type SkillsDynamicClient, type SkillsDynamicClientOptions } from "./skills-dynamic.js";
...
export type AgentKit = {
  ...
  pluginToggle: PluginToggleClient;
  pluginReload: PluginReloadClient;
  pluginFiles: PluginFilesClient;
  pluginFolder: PluginFolderClient;
  pluginSearch: PluginSearchClient;
  pluginSend: PluginSendClient;
  pluginLLM: PluginLLMClient;
  pluginMemory: PluginMemoryClient;
  pluginKnowledge: PluginKnowledgeClient;
  pluginAgentMemory: PluginAgentMemoryClient;
  pluginCron: PluginCronClient;
  pluginExtensions: PluginExtensionsClient;
  skills: SkillsClient;
  skillsCatalog: SkillsCatalogClient;
  skillsScan: SkillsScanClient;
  skillsSuggestions: SkillsSuggestionsClient;
  skillsDynamic: SkillsDynamicClient;
...
export function createAgentKit(options: AgentKitOptions): AgentKit {
  ...
  return {
    ...
    pluginToggle: createPluginToggleClient(common),
    pluginReload: createPluginReloadClient(common),
    pluginFiles: createPluginFilesClient(common),
    pluginFolder: createPluginFolderClient(common),
    pluginSearch: createPluginSearchClient(pluginOptions),
    pluginSend: createPluginSendClient(pluginOptions),
    pluginLLM: createPluginLLMClient(pluginOptions),
    pluginMemory: createPluginMemoryClient(pluginOptions),
    pluginKnowledge: createPluginKnowledgeClient(pluginOptions),
    pluginAgentMemory: createPluginAgentMemoryClient(pluginOptions),
    pluginCron: createPluginCronClient(pluginOptions),
    pluginExtensions: createPluginExtensionsClient(pluginOptions),
    ...
    skillsDynamic: createSkillsDynamicClient(common),
