...
// WASM Plugin installer continuation/download/signature-verification/package-inspect
// writebacks grow the existing yunque-client/wasm-plugin slice with nested
// approval-store consumer, installer handoff, pack-local download cache response
// types, Ed25519 verifier store/record contracts, and verified archive layout
// inspection record/store contracts.
